...
<script>
	...
	function handleFilesSelect(e) {
		...
		if (
			...
			(acceptedFiles.length >= 1 && acceptedFiles[0].name.includes('.svg'))
		) {
			console.log(fileRejections);
			reset();
			alert(
				'The selected file is not in an accepted format. Please only include .png, .jpg, jpeg, or .gif files.'
			);
		} else {
...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-5">
		<h1 class="h1">Classifying Airplanes With Vision Transformer!</h1>
		...
		<main>
			...
			<div class="disclaimer">
				<p>
					All images of Pokemon displayed to the right are sprites owned by <a
						href="https://www.nintendo.com/">Nintendo</a
					>.
				</p>
			</div>
		</main>
